...
ActiveRecord::Schema.define(version: 2020_02_07_145040) do
  ...
  create_table "capes", force: :cascade do |t|
    ...
    t.integer "durability", default: 1, null: false
    t.integer "power", default: 1, null: false
    t.integer "combat", default: 1, null: false
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.bigint "cape_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cape_id"], name: "index_reviews_on_cape_id"
